...
GPIO_ITEM(PINNAME_PCM_OUT,        PINDIRECTION_OUT,    PINLEVEL_HIGH,  PINPULLSEL_PULLUP)
...
//GPIO_ITEM(PINNAME_SD_DATA,            PINDIRECTION_OUT,    PINLEVEL_LOW,  PINPULLSEL_PULLDOWN)	//DOUT1
GPIO_ITEM(PINNAME_DCD,         PINDIRECTION_OUT,    PINLEVEL_HIGH,  PINPULLSEL_PULLUP)
GPIO_ITEM(PINNAME_DTR,            PINDIRECTION_IN,    PINLEVEL_HIGH,  PINPULLSEL_PULLUP)
#endif
