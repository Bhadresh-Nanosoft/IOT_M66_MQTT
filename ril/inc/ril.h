...
typedef enum {
    ...
    URC_NEW_SMS_IND, //8           // Indication for new short message.
    URC_MEMORY_INIT,
    URC_SMS_STATE_IND,
    URC_SIGNAL_QUAL_IND,
	URC_READ_SMS_IND,
	...
	URC_IMEI_STATE_IND,
	URC_IMSI_STATE_IND,
	URC_GET_OPERATOR_IND,
	URC_OPERATOR_SELECT_IND,
	URC_GET_PDP_IND,
	URC_REG_PDP_IND,
	URC_CONFIG_PDP_IND,
	URC_ACTIVATE_GPRS,
	...
	URC_CONNECT_SERVER,
	URC_CONNECT_PACKET,
	URC_SUBSCRIBE_PACKET,
	URC_SUBSCRIBE_PACKET_T,
	URC_SUBSCRIBE_PACKET_C,
	URC_PUBLISH_PACKET,
	URC_HISTORY_PACKET,
	URC_PING_PACKET,
	URC_MODBUS_DATA,
