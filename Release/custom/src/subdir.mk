...
custom/src/%.o: ../custom/src/%.c
	...
	arm-none-eabi-gcc -D__FLOWMETER_GSM__ -D__OCPU_COMPILER_GCC__ -I"${GCC_PATH}\arm-none-eabi\include" -I"F:\Deepak\RS485_TO_GSM\REV_TOT_EFM\RS-485\include" -I"F:\Deepak\RS485_TO_GSM\REV_TOT_EFM\RS-485\ril\inc" -I"F:\Deepak\RS485_TO_GSM\REV_TOT_EFM\RS-485\custom\config" -I"F:\Deepak\RS485_TO_GSM\REV_TOT_EFM\RS-485\custom\fota\inc" -I"F:\Deepak\RS485_TO_GSM\REV_TOT_EFM\RS-485\custom\inc" -O2 -Wall -std=c99 -c -fmessage-length=0 -mlong-calls -Wstrict-prototypes -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -march=armv5te -mthumb-interwork -mfloat-abi=soft -o "$@" "$<"
